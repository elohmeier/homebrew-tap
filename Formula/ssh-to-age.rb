class SshToAge < Formula
  ...
  on_macos do
    on_intel do
      url "https://github.com/elohmeier/ssh-to-age/releases/download/1.3.0/ssh-to-age.darwin-amd64"
      sha256 "c042396745daa23563065a598d78b521b95f61726e61248002f5980941d0f7b9"
    end

    on_arm do
      url "https://github.com/elohmeier/ssh-to-age/releases/download/1.3.0/ssh-to-age.darwin-arm64"
  ...
  on_linux do
    on_intel do
      url "https://github.com/elohmeier/ssh-to-age/releases/download/1.3.0/ssh-to-age.linux-amd64"
      sha256 "0fa89a64ee81a13a86f678fa1dc5d7101d152592c87cb89d91ab23f69127fa76"
    end

    on_arm do
      url "https://github.com/elohmeier/ssh-to-age/releases/download/1.3.0/ssh-to-age.linux-arm64"
  ...
  test do
    output = shell_output("#{bin}/ssh-to-age -h 2>&1")
